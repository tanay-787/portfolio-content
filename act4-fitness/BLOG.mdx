...
<img src="/act4-fitness/calorie-goal-set.png/" alt="Calorie Goal Set Dialog" className="rounded-lg" />
...
<img src="/act4-fitness/weight-graph.png/" alt="Weight Graph" className="rounded-lg" />
